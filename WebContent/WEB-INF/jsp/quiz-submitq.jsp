...
<body class="Main">
	<jsp:include page="html/header.html" />
      ...
      <div class="Form">
			...
			<form:form name="CreateQuestionForm" method="post" action="submit-question.q" commandName="question">
				...
				<br/>
				<div class="FieldDiv">
					<a class="SaveButton" href="javascript:" onclick="document.CreateQuestionForm.submit()">Submit</a>
