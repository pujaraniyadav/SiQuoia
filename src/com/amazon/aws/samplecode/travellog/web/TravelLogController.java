...
public class TravelLogController {
     ...
     * New code from here
     */
    @RequestMapping(value="/createNothing.do")
    public ModelAndView doshome (ModelMap model) 
    {
    ...
    private void preloadJournal() {
        ...
        String bucket = config.getBundleProperty(Configuration.BUNDLE_BUCKET_KEY);
        String path = config.getBundleProperty(Configuration.BUNDLE_PATH_KEY);
